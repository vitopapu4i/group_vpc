    ...
    <section className="relative overflow-hidden border-b border-border bg-background text-foreground">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 md:pt-28 md:pb-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="inline-flex items-center rounded-full border border-border bg-card px-4 py-2 text-xs sm:text-sm text-muted-foreground mb-6">
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-8 max-w-2xl mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Link href="/request">
                <Button className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground px-7 py-6 text-base font-semibold">
                  Оставить заявку
              ...
              <Link href="/projects">
                <Button
                  variant="outline"
                  className="w-full sm:w-auto border-border bg-card text-foreground hover:bg-muted px-7 py-6 text-base"
                >
                  Смотреть проекты
                </Button>
              </Link>
            ...
            <div className="relative rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-xl">
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="rounded-2xl bg-muted border border-border p-5">
                  <p className="text-3xl font-bold text-foreground mb-1">2013–2025</p>
                  <p className="text-sm text-muted-foreground">Реализованные проекты</p>
                </div>

                <div className="rounded-2xl bg-muted border border-border p-5">
                  <p className="text-3xl font-bold text-foreground mb-1">DAS / ADAS</p>
                  <p className="text-sm text-muted-foreground">Indoor и транспортные решения</p>
                </div>

                <div className="rounded-2xl bg-muted border border-border p-5">
                  <p className="text-3xl font-bold text-foreground mb-1">5 офисов</p>
                  <p className="text-sm text-muted-foreground">Москва, Прага, Астана, Дубай, Минск</p>
                </div>

                <div className="rounded-2xl bg-muted border border-border p-5">
                  <p className="text-3xl font-bold text-foreground mb-1">24/7</p>
                  <p className="text-sm text-muted-foreground">Инженерная и проектная поддержка</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl bg-primary/5 border border-primary/15 p-5">
                ...
                <div className="space-y-3 text-sm text-foreground">
                  <div className="flex items-start justify-between gap-4 border-b border-border pb-3">
                    <span>Поставка телекоммуникационного оборудования</span>
                    <span className="text-muted-foreground">01</span>
                  </div>
                  <div className="flex items-start justify-between gap-4 border-b border-border pb-3">
                    <span>Планирование систем связи</span>
                    <span className="text-muted-foreground">02</span>
                  </div>
                  <div className="flex items-start justify-between gap-4 border-b border-border pb-3">
                    <span>Реализация проектов под ключ</span>
                    <span className="text-muted-foreground">03</span>
                  </div>
                  <div className="flex items-start justify-between gap-4 border-b border-border pb-3">
                    <span>Аудит и обслуживание существующих систем</span>
                    <span className="text-muted-foreground">04</span>
                  </div>
                  <div className="flex items-start justify-between gap-4">
                    <span>Измерения и радиообследование</span>
